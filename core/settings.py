...
SECRET_KEY = 'django-insecure-@a67xv&lmmlcjcg4qeg2j17y2)t-+7^k0nzwxkg7k1q+igz--1'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DATABASE_NAME', 'testdatabase'),
...
# connections.configure(default={'hosts': 'http://localhost:9200'})
